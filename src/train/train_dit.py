...
def run_stage(
    ...
    return {
        ...
        "best_epoch": best_epoch if best_val_f1 > -1.0 else 0,
...
def train(config_path: str) -> None:
    ...
    model = DiTClassifier(model_name=model_name, num_classes=num_classes).to(device)
    ...
    logger.info("Loading best checkpoint (%s) for final evaluation …", best_stage)
